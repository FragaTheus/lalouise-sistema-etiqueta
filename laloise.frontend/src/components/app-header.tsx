...
export default function AppHeader() {
  return (
    <header className="w-full px-4 py-3 h-auto flex items-center justify-between fixed bg-gradient-to-r from-card to-card/95 border-b border-border/50 shadow-sm lg:hidden z-50 backdrop-blur-sm bg-card/80">
